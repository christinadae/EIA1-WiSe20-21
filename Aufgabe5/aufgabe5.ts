...
console.log ('Für Europa hat sich 2018 im Vergleich zu 2008 die Emission um ' + Math.round( ((europa2018/europa2008)-1)*100) + '% verändert')
...
console.log ('Für Nordamerika hat sich 2018 im Vergleich zu 2008 die Emission um ' + Math.round( ((nordamerika2018/nordamerika2008)-1)*100) + '% verändert')
...
console.log ('Für Südamerika hat sich 2018 im Vergleich zu 2008 die Emission um ' + Math.round ( ((südamerika2018/südamerika2008)-1)*100) + '% verändert')
...
console.log ('Für Afrika hat sich 2018 im Vergleich zu 2008 die Emission um ' + Math.round( ((afrika2018/afrika2008)-1) *100) + '% verändert')
...
console.log ('Für Asien hat sich 2018 im Vergleich zu 2008 die Emission um ' + Math.round( ((asien2018/asien2008)-1)*100) + '% verändert')
...
console.log ('Für Australien hat sich 2018 im Vergleich zu 2008 die Emission um ' + Math.round( ((australien2018/australien2008)-1)*100) + '% verändert')
